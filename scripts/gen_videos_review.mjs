...
// 8 videos de Magaly que NO tienen variante equivalente en el banco → falta decidir
// a qué ejercicio van (o crear el ejercicio nuevo). Reproducibles para verlos.
const gymOrphans=[
  ...
  ['lagartijas-modificadas-pecho-triceps','Lagartija modificada (rodillas)','no hay flexión en rodillas estándar'],
