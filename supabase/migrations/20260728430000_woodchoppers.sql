...
select v.ex, null, v.url, 'Ejecución', 0 from (values
  ('woodchopper-polea-baja', 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/GYM/cruces-de-polea-baja-agarre-supino-en-maquina-pecho-superior.mp4'),
  ('woodchopper-polea-alta', 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/GYM/cruces-de-polea-alta-a-baja-pecho-inferior-hombros.mp4')
  ) as v(ex, url)
