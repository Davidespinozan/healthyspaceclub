...
update public.exercise_videos set exercise_id='hiperextensiones' where video_url='https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/GYM/extension-espalda-baja-maquina-core.mp4' and exercise_id is distinct from 'hiperextensiones';
