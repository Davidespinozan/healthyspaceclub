-- ════════════════════════════════════════════════════════════════
-- RECONSTRUCCIÓN final exercise_videos (lote 2, completo, 36 videos).
-- Incluye los 2 que se habían escapado: triceps-push-down-cuerda y
-- remo-bajo-polea (remo horizontal pesado). Tracción vertical pesada se fusionó
-- con el jalón → los videos de jalón cubren ese movimiento.
-- ════════════════════════════════════════════════════════════════
...
INSERT INTO exercise_videos (exercise_id, video_url, display_order) VALUES ('aperturas-pec-deck', 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/GYM/pec-deck-en-maquina-pecho.mp4', 0);
...
INSERT INTO exercise_videos (exercise_id, video_url, display_order) VALUES ('hiperextensiones-maquina', 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/GYM/extension-espalda-baja-maquina-core.mp4', 0);
...
INSERT INTO exercise_videos (exercise_id, video_url, display_order) VALUES ('press-triceps-maquina-sentado', 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/GYM/press-triceps-sentado-en-maquina-triceps.mp4', 0);
...
INSERT INTO exercise_videos (exercise_id, video_url, display_order) VALUES ('hiperextensiones-banco-romano', 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/GYM/hiperextensiones-banco-romano-espalda-baja.mp4', 0);
...
INSERT INTO exercise_videos (exercise_id, video_url, display_order) VALUES ('jalon-neutro-triangulo', 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/GYM/jalon-frontal-triangulo-maquina-espalda.mp4', 0);
INSERT INTO exercise_videos (exercise_id, video_url, display_order) VALUES ('jalon-neutro', 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/GYM/jalon-al-pecho-polea-alta-agarre-neutro-ancho-espalda.mp4', 0);
...
INSERT INTO exercise_videos (exercise_id, video_url, display_order) VALUES ('press-horizontal-maquina', 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/GYM/press-horizontal-maquina-agarre-neutral-pecho-tricep.mp4', 0);
...
INSERT INTO exercise_videos (exercise_id, video_url, display_order) VALUES ('triceps-push-down-barra-recta', 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/GYM/triceps-push-down-barra-recta.mp4', 0);
INSERT INTO exercise_videos (exercise_id, video_url, display_order) VALUES ('remo-bajo-polea', 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/GYM/remo-bajo-polea-espalda.mp4', 0);
