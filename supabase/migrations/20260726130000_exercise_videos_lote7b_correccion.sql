...
--    Aperturas · Cruces en polea (aperturas-polea-cruce). Se conectan ahí.
--    (Si más adelante se quieren separar por agarre/altura como variantes
--     distintas, se crean; por ahora es el ejercicio que ya existe.)
-- ═══════════════════════════════════════════════════════════════════════════
...
select v.ex, null, v.url, 'Ejecución', 0
  ...
  ('aperturas-polea-cruce', 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/GYM/cruces-de-polea-alta-agarre-prono-en-maquina-pecho-inferior.mp4'),
  ('aperturas-polea-cruce', 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/GYM/cruces-de-polea-baja-agarre-supino-en-maquina-pecho-superior.mp4'),
  ('aperturas-polea-cruce', 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/GYM/cruces-de-polea-baja-apertura-en-maquina-pecho-superior.mp4')
  ) as v(ex, url)
