...
--
-- 1) pec-deck-en-maquina-pecho.mp4 → es un PEC DECK, no cruces en polea.
...
delete from public.exercise_videos where video_url = 'pec-deck-en-maquina-pecho.mp4';
...
select v.ex, null, v.url, 'Ejecución', 0
  from (values
  ('aperturas-pec-deck', 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/GYM/pec-deck-en-maquina-pecho.mp4'),
