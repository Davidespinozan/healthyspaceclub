...
select v.ex, null, v.url, 'Ejecución', 0 from (values
  ('press-declinado-polea', 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/GYM/press-declinado-en-polea-alta-pecho-inferior.mp4')
  ) as v(ex, url)
