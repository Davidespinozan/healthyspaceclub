...
--        2) triceps-push-down-cuerda.mp4 en realidad es BARRA RECTA (Magaly se equivocó);
...
update public.exercise_videos set exercise_id='triceps-push-down-barra-recta'
  where video_url like '%triceps-push-down-cuerda.mp4%' and exercise_id='triceps-push-down-cuerda';
