...
import { mealNamesEn } from './mealPlan.en';
...
const planA: DayPlan[] = [
  { day: 1, theme: '🇲🇽 Mexicana', meals: [
    { time: 'Desayuno', name: 'Chilaquiles Ligeros', desc: 'Salsa verde casera · totopos horneados', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/CHILAQUILES%20LIGEROS%20.png', portions: ['Salsa verde hecha en casa', '1 tz totopos horneados', '2 pz de huevo', '60 g queso panela o fresco', '2/3 pz de aguacate'] },
    { time: 'Comida', name: 'Alambre de Pollo', desc: 'Proteína + arroz + verduras', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/ALAMBRE%20DE%20POLLO.png', portions: ['200 g pechuga de pollo salpimentada', 'Pimientos, brócoli, chile y cebolla', '30 g queso oaxaca o mozzarella', '2 tz arroz cocido'] },
  ...
  { day: 2, theme: '🇲🇽 Mexicana', meals: [
    { time: 'Desayuno', name: 'Omelette', desc: 'Alto en proteína · con pan integral', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/OMELETTE.png', portions: ['4 huevos', '¾ tz claras de huevo', '4 reb pechuga de pavo', 'Espinaca + chile, tomate y cebolla', '4 reb pan integral + 1 tz frutos rojos'] },
    { time: 'Comida', name: 'Caldo de Pollo', desc: 'Reconfortante · con arroz', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/CALDO%20DE%20POLLO.png', portions: ['200 g pechuga de pollo cocida', 'Caldo con verduras (chayote, zanahoria, calabaza, ejote)', '3 tz arroz blanco cocido', 'Limón y hierbas al gusto'] },
  ...
  { day: 3, theme: '🇲🇽 Mexicana', meals: [
    { time: 'Desayuno', name: 'Machaca con Nopales', desc: 'Tradicional · con tortillas', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/MACHACA%20CON%20NOPALES.png', portions: ['40 g machaca de res', '1 taza claras de huevo', 'Nopales en tiras, tomate + cebolla + chile + cilantro', '4 tortillas de maíz', '½ aguacate', '1 naranja'] },
  ...
  { day: 4, theme: '🇲🇽 Mexicana', meals: [
    { time: 'Desayuno', name: 'Huevos Rancheros', desc: 'Clásico mexicano · con frijoles', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/HUEVOS%20RANCHEROS.png', portions: ['6 huevos', '⅔ taza frijoles cocidos', 'Nopal picado', '1 tortilla de maíz', '½ pz aguacate', 'Salsa libre (tomate, cebolla, chile, cilantro)'] },
    { time: 'Comida', name: 'Tinga de Pollo', desc: 'Deshebrada · con arroz', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/TINGA%20DE%20POLLO.png', portions: ['230 g pechuga de pollo deshebrada', '3 tz arroz blanco cocido', 'Lechuga + tomate + cebolla', '2 cdas salsa chipotle', 'Limón'] },
  ...
  { day: 5, theme: '🇲🇽 Mexicana', meals: [
    { time: 'Desayuno', name: 'Molletes con Huevo', desc: 'Pan integral + frijoles + huevo', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/MOLLETES%20CON%20HUEVO.png', portions: ['4 reb pan integral', '⅔ tz frijoles machacados sin grasa', '2 huevo + ½ tz claras', '60 g queso panela o fresco', 'Pico de gallo libre, limón y sal'] },
    { time: 'Comida', name: 'Asado de Res', desc: 'Con papa y verduras', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/ASADO%20DE%20RES.png', portions: ['200 g carne de res', '1 pz papa, 2 pz tomate, ½ cebolla, 1 ajo', 'Lechuga, zanahoria, pepino, cebolla curtida', '30 g queso panela + ⅓ aguacate'] },
  ...
  { day: 7, theme: '🇲🇽 Mexicana', meals: [
    { time: 'Desayuno', name: 'Calabacitas', desc: 'Con huevo y pan integral', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/CALABACITAS.png', portions: ['Calabacita en cubos, tomate, cebolla y chile', '3 huevo + ½ taza claras', '4 reb pan integral', 'Sal, pimienta y orégano al gusto'] },
    { time: 'Comida', name: 'Bistec de Res', desc: 'Con salsa de tomate y arroz', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/BISTEC%20DE%20RES.png', portions: ['200 g bistec de res salpimentado', 'Salsa de tomate hecha en casa', '2 tz arroz cocido'] },
  ...
  { day: 8, theme: '🇯🇵 Japonesa', meals: [
    { time: 'Desayuno', name: 'Yogurt Coco-Mango', desc: 'Tropical · con amaranto', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/YOGURT%20COCO%20-%20MANGO%20.png', portions: ['1 tz yogurt natural sin azúcar', '1 taza mango en cubos', '½ pz plátano', '2 cdas coco rallado natural sin azúcar', '2 cda amaranto inflado', '1 cdita miel'] },
  ...
  { day: 9, theme: '🇯🇵 Japonesa', meals: [
    { time: 'Desayuno', name: 'Bowl', desc: 'Huevos + queso de cabra + blueberries', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/BOWL.png', portions: ['4 huevos cocidos', '30 g queso fresco de cabra', 'Espinaca fresca', '⅓ pz de aguacate', '⅓ tz de blueberries', '4 pz pan integral tostado'] },
    { time: 'Comida', name: 'Poké Bowl', desc: 'Arroz + proteína + aguacate', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/POKE%20BOWL.png', portions: ['2 tz arroz cocido', '200 g pechuga de pollo o pescado blanco', 'Pepino + zanahoria', '30 g queso crema', '⅓ aguacate', 'Salsa soya baja en sodio + naranja + limón'] },
  ...
  { day: 10, theme: '🇯🇵 Japonesa', meals: [
    { time: 'Desayuno', name: 'Avena con Manzana', desc: 'Con leche y huevos', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/AVENA%20CON%20MANZANA.png', portions: ['1 tz avena + agua', '2 tz leche', '1 cda miel + canela en polvo', '1 manzana', '1 cda semillas mixtas', '5 huevos revueltos'] },
    { time: 'Comida', name: 'Ramen Ligero', desc: 'Fideos + pollo + huevo', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/RAMEN%20LIGERO.png', portions: ['3 tz fideos cocidos', '200 g pollo o tofu firme', 'Espinaca, brócoli y champiñones', '2 huevo cocido', 'Caldo ligero (sal, salsa soya, chile cayena)'] },
  ...
  { day: 11, theme: '🇯🇵 Japonesa', meals: [
    { time: 'Desayuno', name: 'Pancakes de Camote', desc: 'Con yogur y miel', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/PANCAKES%20DE%20CAMOTE.png', portions: ['2 tz puré de camote', '1 huevo + ¼ tz claras', '1 tz avena molida', 'Canela y vainilla', '¼ tz yogur natural + 1 cdta miel', '2 pz de huevos'] },
    { time: 'Comida', name: 'Salmón al Limón', desc: 'Con papa y espárragos', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/SALMON%20AL%20LIMON.png', portions: ['180 g salmón al sartén', '1 cdita mantequilla + ajo + limón', '1 pz de papa', 'Espárragos salteados', '1 tz arroz cocido'] },
  ...
  { day: 12, theme: '🇯🇵 Japonesa', meals: [
    { time: 'Desayuno', name: 'Rice Pudding Japonés', desc: 'Arroz con leche + huevos', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/RICE%20PUDDING%20JAPONES.png', portions: ['Arroz cocido con agua primero', '1 taza leche (descremada o vegetal)', 'Canela, vainilla y pizca de sal a fuego bajo', '2 tz de arroz', '3 pz de huevo'] },
  ...
  { day: 13, theme: '🇯🇵 Japonesa', meals: [
    { time: 'Desayuno', name: 'Smoothie de Plátano', desc: 'Con espinaca y semillas', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/SMOOTHIE%20DE%20PLATANOO.png', portions: ['1 pz plátano', '1 tz espinaca fresca', '1 tz leche', '1 cda semillas mixtas (10 g)', 'Agua y hielos', '2 pz de huevos'] },
    { time: 'Comida', name: 'Pollo con Verduras', desc: 'Estilo asiático con papa', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/POLLO%20CON%20VERDURAS.png', portions: ['180 g pechuga de pollo', 'Brócoli, zanahoria, calabacita y pimientos', 'Salsa soya + ajo + limón + chile cayenna', '2 pz papa al horno o cocida'] },
  ...
  { day: 14, theme: '🇯🇵 Japonesa', meals: [
    { time: 'Desayuno', name: 'Toast de Huevo', desc: 'Con aguacate y yogur', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/TOAST%20DE%20HUEVO%20.png', portions: ['3 reb pan integral', '¼ pz aguacate', 'Espinaca y champiñones', '3 huevo + ½ taza claras', '¾ taza yogurt natural sin azúcar', '½ taza frutos rojos + 1 cdita miel'] },
    { time: 'Comida', name: 'Bowl de Camarón', desc: 'Con arroz y brócoli', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/BOWL%20DE%20CAMARON%20.png', portions: ['200 g camarones con mantequilla, ajo, paprika', 'Brócoli salteado', 'Salsa soya + limón', '2 tz arroz cocido'] },
  ...
  { day: 15, theme: '🇮🇹 Italiana', meals: [
    { time: 'Desayuno', name: 'Ricotta Toast Durazno', desc: 'Pan integral + ricotta + fruta', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/RICOTTA%20TOAST%20DURAZNO%20.png', portions: ['4 reb pan integral', '½ tz ricotta light', '1 pz durazno', '1 cdita miel', '1 cdita semillas (chía o girasol)'] },
    { time: 'Comida', name: 'Ensalada Griega', desc: 'Pollo + garbanzos + arroz', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/ENSALADA%20GRIEGA%20.png', portions: ['180 g pechuga de pollo a la plancha', '1 tz garbanzos cocidos', 'Espinaca + lechuga + tomate cherry + pepino', '2 cdita queso parmesano', '1 cdita aceite de oliva, limón, orégano', '2 tz arroz cocido'] },
  ...
  { day: 16, theme: '🇮🇹 Italiana', meals: [
    { time: 'Desayuno', name: 'Huevos Mediterráneos', desc: 'Con pan integral y aguacate', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/HUEVOS%20MEDITERRANEOS.png', portions: ['5 pz huevo + ½ taza claras', 'Tomate cherry, cebolla y espinaca', '3 reb pan integral, ¼ aguacate', '1 cdita queso feta o panela', 'Orégano, albahaca, pimienta'] },
    { time: 'Comida', name: 'Filete de Pescado', desc: 'Con mantequilla, arroz y espárragos', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/FILETE%20DE%20PESCADO%20.png', portions: ['200 g filete de pescado blanco', '1 cdita mantequilla + ajo + limón', '3 tz arroz cocido', 'Espárragos y zanahoria salteados'] },
  ...
  { day: 17, theme: '🇮🇹 Italiana', meals: [
    { time: 'Desayuno', name: 'Toast', desc: 'Aguacate + huevo + tomate', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/TOAST.png', portions: ['2 reb pan integral', '⅓ pz aguacate', 'Rodajas de tomate', '3 pz huevo estrellado', 'Sal, limón, pimienta', '1 pz kiwi'] },
  ...
  { day: 19, theme: '🇮🇹 Italiana', meals: [
    { time: 'Desayuno', name: 'Smoothie de Frutos Rojos', desc: 'Yogur + avena + chía', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/SMOOTHIE%20DE%20FRUTOS%20ROJOS.png', portions: ['½ taza yogurt natural sin azúcar', '1 tz leche', '½ taza frutos rojos', '2 cdas avena natural', '1 cdita miel + 1 cdita chía', '2 pz huevo revuelto + 4 pz pan tostado'] },
  ...
  { day: 20, theme: '🇮🇹 Italiana', meals: [
    { time: 'Desayuno', name: 'Toast de Pera y Maní', desc: 'Pan integral + yogur + fruta', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/TOAST%20DE%20PERA%20Y%20MANI.png', portions: ['3 reb pan integral', '1 cdita crema de cacahuate natural', '1 pera en láminas', '1 taza yogurt griego sin azúcar', '½ cdita miel + canela', '3 pz de huevo'] },
    { time: 'Comida', name: 'Pasta con Verduras', desc: 'Con pollo y parmesano', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/PASTA%20CON%20VERDURAS.png', portions: ['2 tz pasta cocida en salsa de tomate', '200 g pechuga de pollo', 'Tomate cherry y brócoli', 'Ajo, albahaca y orégano', '1 cdita parmesano rallado'] },
  ...
  { day: 21, theme: '🇮🇹 Italiana', meals: [
    { time: 'Desayuno', name: 'Ricotta Toast', desc: 'Con fresas y semillas', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/RICOTTA%20TOAST.png', portions: ['4 reb pan integral', '6 cda ricotta light', '1 tz fresas picadas', '1 cdita miel', '2 cdita semillas (chía o girasol)'] },
    { time: 'Comida', name: 'Pollo al Romero', desc: 'Con papa y verduras', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/POLLO%20AL%20ROMERO.png', portions: ['180 g pechuga de pollo', '2 papas cocida', 'Espinaca, tomate cherry y pepino', 'Romero, ajo, limón y pimienta'] },
  ...
  { day: 22, theme: '🇺🇸 Americana', meals: [
    { time: 'Desayuno', name: 'Lemon Overnight Oats', desc: 'Preparar la noche anterior', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/LEMON%20OVERNIGHT%20OATS.png', portions: ['1 taza avena + ½ tz yogurt natural + 1 tz leche', '1 cdita semillas de chía', 'Ralladura y jugo de limón', '1 cdita miel o stevia', '1 tz frutos rojos', '3 pz huevo revuelto'] },
    { time: 'Comida', name: 'Hamburguesa Ligera', desc: 'Carne magra + pan integral', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/HAMBURGUESA%20LIGERA.png', portions: ['150 g carne molida magra', '2 reb pan integral', '⅓ pz aguacate', '30 g queso fresco o mozzarella', 'Lechuga, tomate, cebolla, pepino', '1 ½ taza camote al horno o papa'] },
  ...
  { day: 23, theme: '🇺🇸 Americana', meals: [
    { time: 'Desayuno', name: 'Bagel de Salmón', desc: 'Ligero · con queso crema', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/BAGEL%20DE%20SALMON.png', portions: ['½ bagel integral', '40 g salmón ahumado o pollo a la plancha', '1 cdita queso crema light', 'Tomate y pepino en rodajas', 'Limón, eneldo y pimienta'] },
    { time: 'Comida', name: 'Chicken Bowl', desc: 'Arroz + frijoles + aguacate', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/CHICKEN%20BOWL.png', portions: ['150 g pechuga de pollo a la plancha', '2 tz arroz cocido', '½ tz frijoles', '¼ pz aguacate', 'Lechuga + pico de gallo + 1 cda elotito', 'Limón y sal de mar'] },
  ...
  { day: 24, theme: '🇺🇸 Americana', meals: [
    { time: 'Desayuno', name: 'Toast de Huevo', desc: 'Pan integral + claras + aguacate', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/TOAST%20DE%20HUEVO%20.png', portions: ['2 reb pan integral', '¾ taza claras de huevo + 1 huevo entero', '¼ pieza aguacate', 'Rodajas de tomate + espinaca fresca', 'Limón, sal y pimienta'] },
    { time: 'Comida', name: 'Ensalada Cobb', desc: 'Pavo + huevo + aguacate', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/ENSALADA%20COBB.png', portions: ['150 g pechuga de pavo o pollo a la plancha', '1 huevo cocido', 'Espinaca + lechuga + tomate cherry + 2 cdas elote', '¼ aguacate + 30 g queso panela o feta', 'Aderezo del recetario'] },
  ...
  { day: 25, theme: '🇺🇸 Americana', meals: [
    { time: 'Desayuno', name: 'Desayuno Americano', desc: 'Hot cakes fit + huevo + jamón', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/DESAYUNO%20AMERICANO.png', portions: ['Hot cakes: ½ taza avena molida + ½ taza claras + vainilla y canela', 'Topping: ½ taza fresas o frutos rojos', '1 cdita miel', '2 huevo + 2 reb jamón de pavo asado'] },
    { time: 'Comida', name: 'Salmón con Quinoa Bowl', desc: 'Aguacate + verduras frescas', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/SALMON%20CON%20QUINOA%20BOWL.png', portions: ['150 g salmón a la plancha salpimentada', '2 taza quinoa cocida', '½ aguacate', 'Pepino, cebolla morada, pimientos, tomate cherry', 'Limón, sal y ajonjolí'] },
  ...
  { day: 26, theme: '🇺🇸 Americana', meals: [
    { time: 'Desayuno', name: 'Wrap', desc: 'Huevo + jamón + aguacate', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/WRAP.png', portions: ['2 tortillas integral', '1 huevo + ½ taza claras', '2 reb jamón de pechuga de pavo', '⅓ aguacate', 'Espinaca y tomate cherry', '1 mandarina'] },
    { time: 'Comida', name: 'Chicken Caesar Bowl', desc: 'Pollo + lechuga + parmesano', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/CHICKEN%20CAESAR%20BOWL.png', portions: ['180 g pechuga de pollo a la plancha', 'Lechuga + espinaca', '2 cdas parmesano rallado', '2 pz papa picada', 'Aderezo del recetario'] },
  ...
  { day: 27, theme: '🇺🇸 Americana', meals: [
    { time: 'Desayuno', name: 'Smoothie de Plátano', desc: 'Cacao + crema de cacahuate', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/SMOOTHIE%20DE%20PLATANOO.png', portions: ['½ tz yogur natural sin azúcar', '1 tz leche', '½ plátano', '2 cditas cacao sin azúcar', '1 cdita crema de cacahuate', '2 cdas avena + 1 cdita miel'] },
  ...
  { day: 28, theme: '🇺🇸 Americana', meals: [
    { time: 'Desayuno', name: 'Apple Crumble Avena Horneada', desc: 'Avena + manzana al horno', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/APPLE%20CRUMBLE%20AVENA%20HORNEADA.png', portions: ['1 tz avena', 'Canela, vainilla y pizca de sal', '1 cdita mantequilla', '1 manzana en cubos + canela + 1 cdita miel, hornea todo'] },
...
const planB: DayPlan[] = [
  { day: 1, theme: '🇲🇽 Mexicana', meals: [
    ...
    { time: 'Comida', name: 'Alambre de Pollo', desc: 'Proteína + arroz + verduras', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/ALAMBRE%20DE%20POLLO.png', portions: ['200 g pechuga de pollo salpimentada', 'Pimientos, brócoli, chile y cebolla', '30 g queso oaxaca o mozzarella', '4 tortillas o 1 taza arroz cocido'] },
    { time: 'Cena', name: 'Ceviche de Panela', desc: 'Ligero · fresco · proteico', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/CEVICHE%20DE%20PANELA.png', portions: ['150 g queso panela', 'Chile, cebolla morada, pepino', '1/3 pz de aguacate', 'Jugo de limón, sal y salsa soya', '1 tz totopos horneados'] },
  ...
  { day: 2, theme: '🇲🇽 Mexicana', meals: [
    { time: 'Desayuno', name: 'Omelette', desc: 'Alto en proteína · con pan integral', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/OMELETTE.png', portions: ['2 huevos', '¾ tz claras de huevo', '4 reb pechuga de pavo', 'Espinaca + chile, tomate y cebolla', '4 reb pan integral + 1 tz frutos rojos'] },
    { time: 'Comida', name: 'Caldo de Pollo', desc: 'Reconfortante · con arroz', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/CALDO%20DE%20POLLO.png', portions: ['180 g pechuga de pollo cocida', 'Caldo con verduras (chayote, zanahoria, calabaza, ejote)', '2 tz arroz blanco cocido', 'Limón y hierbas al gusto'] },
  ...
  { day: 4, theme: '🇲🇽 Mexicana', meals: [
    { time: 'Desayuno', name: 'Huevos Rancheros', desc: 'Clásico mexicano · con frijoles', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/HUEVOS%20RANCHEROS.png', portions: ['4 huevos', '⅔ taza frijoles cocidos', 'Nopal picado', '1 tortilla de maíz', '½ pz aguacate', 'Salsa libre (tomate, cebolla, chile, cilantro)'] },
    { time: 'Comida', name: 'Tinga de Pollo', desc: 'Deshebrada · con arroz', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/TINGA%20DE%20POLLO.png', portions: ['230 g pechuga de pollo deshebrada', '2 tz arroz blanco cocido', 'Lechuga + tomate + cebolla', '2 cdas salsa chipotle', 'Limón'] },
  ...
  { day: 7, theme: '🇲🇽 Mexicana', meals: [
    { time: 'Desayuno', name: 'Calabacitas', desc: 'Con huevo y pan integral', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/CALABACITAS.png', portions: ['Calabacita en cubos, tomate, cebolla y chile', '3 huevo + ½ taza claras', '4 reb pan integral', 'Sal, pimienta y orégano al gusto'] },
    { time: 'Comida', name: 'Bistec de Res', desc: 'Con salsa de tomate y arroz', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/BISTEC%20DE%20RES.png', portions: ['200 g bistec de res salpimentado', 'Salsa de tomate hecha en casa', '1 ½ tz arroz cocido'] },
  ...
  { day: 8, theme: '🇯🇵 Japonesa', meals: [
    { time: 'Desayuno', name: 'Yogurt Coco-Mango', desc: 'Tropical · con semillas', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/YOGURT%20COCO%20-%20MANGO%20.png', portions: ['1 tz yogurt natural sin azúcar', '½ taza mango en cubos', '2 cdas coco rallado natural', '1 cdita miel', '1 cda semillas mixtas', '2 pz huevo revuelto'] },
    { time: 'Comida', name: 'Pollo Teriyaki', desc: 'Con arroz y verduras', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/POLLO%20TERIYAKI.png', portions: ['200 g pechuga de pollo', '2 tz arroz cocido', 'Brócoli, zanahoria, calabacita o pimiento', 'Salsa teriyaki ligera casera'] },
  ...
  { day: 9, theme: '🇯🇵 Japonesa', meals: [
    { time: 'Desayuno', name: 'Bowl', desc: 'Huevos + queso de cabra + blueberries', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/BOWL.png', portions: ['4 huevos cocidos', '30 g queso fresco de cabra', 'Espinaca fresca', '⅓ pz de aguacate', '⅓ tz de blueberries', '2 pz pan integral tostado'] },
    { time: 'Comida', name: 'Poké Bowl', desc: 'Arroz + proteína + aguacate', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/POKE%20BOWL.png', portions: ['1 ½ tz arroz cocido', '180 g pechuga de pollo', 'Pepino + zanahoria', '30 g queso crema', '⅓ aguacate', 'Salsa soya baja en sodio + naranja + limón'] },
  ...
  { day: 10, theme: '🇯🇵 Japonesa', meals: [
    { time: 'Desayuno', name: 'Avena con Manzana', desc: 'Con leche y huevos', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/AVENA%20CON%20MANZANA.png', portions: ['1 tz avena + agua', '1 tz leche', '1 cda miel + canela en polvo', '1 manzana', '1 cda semillas mixtas', '3 huevos revueltos'] },
    { time: 'Comida', name: 'Ramen Ligero', desc: 'Fideos + pollo + huevo', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/RAMEN%20LIGERO.png', portions: ['2 tz fideos cocidos', '200 g pollo o tofu firme', 'Espinaca, brócoli y champiñones', '1 huevo cocido', 'Caldo ligero (sal, salsa soya, chile cayena)'] },
    { time: 'Cena', name: 'Dumpling Rolls', desc: 'Carne en hojas de lechuga', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/DUMPLING%20ROLLS.png', portions: ['200 g carne molida de res o pavo', 'Zanahoria, champiñones y cebollín', '4 hojas grandes de lechuga', '1 cda de ajonjolí', 'Aderezo chipotle + salsa soya', '1 tz quinoa cocida'] },
  ...
  { day: 11, theme: '🇯🇵 Japonesa', meals: [
    { time: 'Desayuno', name: 'Pancakes de Camote', desc: 'Con yogur y miel', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/PANCAKES%20DE%20CAMOTE.png', portions: ['1 tz puré de camote', '1 huevo + ¼ tz claras', '½ tz avena molida', 'Canela y vainilla', '¼ tz yogur natural + 1 cdta miel (topping)', '2 pz de huevos'] },
    { time: 'Comida', name: 'Salmón al Limón', desc: 'Con papa y espárragos', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/SALMON%20AL%20LIMON.png', portions: ['180 g salmón al sartén', '1 cdita mantequilla + ajo + limón', '2 pz de papa', 'Espárragos salteados'] },
  ...
  { day: 13, theme: '🇯🇵 Japonesa', meals: [
    { time: 'Desayuno', name: 'Smoothie de Plátano', desc: 'Con espinaca y semillas', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/SMOOTHIE%20DE%20PLATANOO.png', portions: ['½ pz plátano', '1 taza espinaca fresca', '¾ taza leche', '1 cda semillas mixtas (10 g)', 'Agua y hielos'] },
    { time: 'Comida', name: 'Pollo con Verduras', desc: 'Estilo asiático con papa', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/POLLO%20CON%20VERDURAS.png', portions: ['180 g pechuga de pollo', 'Brócoli, zanahoria, calabacita y pimientos', 'Salsa soya + ajo + limón + chile cayenna', '2 pz papa al horno o cocida'] },
    { time: 'Cena', name: 'Brochetas Yakitori', desc: 'Con salsa teriyaki y arroz', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/BROCHETAS%20YAKITORI.png', portions: ['180 g carne', 'Pimientos de colores', 'Salsa teriyaki casera', '2 tz arroz cocido'] },
  ...
  { day: 14, theme: '🇯🇵 Japonesa', meals: [
    ...
    { time: 'Comida', name: 'Bowl de Camarón', desc: 'Con arroz y brócoli', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/BOWL%20DE%20CAMARON%20.png', portions: ['200 g camarones con mantequilla, ajo, paprika + limón y sal', 'Brócoli salteado', 'Salsa soya + limón', '1 ½ tz arroz cocido'] },
  ...
  { day: 16, theme: '🇮🇹 Italiana', meals: [
    { time: 'Desayuno', name: 'Huevos Mediterráneos', desc: 'Con pan integral y aguacate', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/HUEVOS%20MEDITERRANEOS.png', portions: ['3 pz huevo + ½ taza claras', 'Tomate cherry, cebolla y espinaca', '3 reb pan integral, ¼ aguacate', '1 cdita queso feta o panela', 'Orégano, albahaca, pimienta'] },
    { time: 'Comida', name: 'Filete de Pescado', desc: 'Con mantequilla, arroz y espárragos', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/FILETE%20DE%20PESCADO%20.png', portions: ['200 g filete de pescado blanco', '1 cdita mantequilla + ajo + limón', '2 tz arroz cocido', 'Espárragos y zanahoria salteados'] },
  ...
  { day: 21, theme: '🇮🇹 Italiana', meals: [
    { time: 'Desayuno', name: 'Ricotta Toast', desc: 'Con fresas y semillas', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/RICOTTA%20TOAST.png', portions: ['3 reb pan integral', '6 cda ricotta light', '1 tz fresas picadas', '1 cdita miel', '1 cdita semillas (chía o girasol)'] },
    { time: 'Comida', name: 'Pollo al Romero', desc: 'Con papa y verduras', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/POLLO%20AL%20ROMERO.png', portions: ['180 g pechuga de pollo', '1 papa cocida', 'Espinaca, tomate cherry y pepino', 'Romero, ajo, limón y pimienta'] },
    { time: 'Cena', name: 'Ensalada Caprese', desc: 'Quinoa + pollo + mozzarella', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/ENSALADA%20CAPRESE.png', portions: ['150 g pechuga de pollo a la plancha', '1 taza quinoa cocida', 'Tomate cherry, pepino y cebolla morada', '¼ taza mozzarella light', 'Albahaca fresca y vinagre balsámico'] },
  ...
  { day: 23, theme: '🇺🇸 Americana', meals: [
    ...
    { time: 'Comida', name: 'Chicken Bowl', desc: 'Arroz + frijoles + aguacate', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/CHICKEN%20BOWL.png', portions: ['120 g pechuga de pollo a la plancha', '1 ½ tz arroz cocido', '½ tz frijoles', '¼ pz aguacate', 'Lechuga + pico de gallo + 1 cda elotito', 'Limón y sal de mar'] },
  ...
  { day: 24, theme: '🇺🇸 Americana', meals: [
    { time: 'Desayuno', name: 'Toast de Huevo', desc: 'Pan integral + claras + aguacate', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/TOAST%20DE%20HUEVO%20.png', portions: ['2 reb pan integral', '½ tz claras de huevo + 1 huevo entero', '¼ pieza aguacate', 'Rodajas de tomate + espinaca fresca', 'Limón, sal y pimienta'] },
    { time: 'Comida', name: 'Ensalada Cobb', desc: 'Pavo + huevo + aguacate', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/ENSALADA%20COBB.png', portions: ['120 g pechuga de pavo ahumada o pollo a la plancha', '1 huevo cocido', 'Espinaca + lechuga + tomate cherry + 2 cdas elote', '¼ aguacate + 30 g queso panela o feta', 'Aderezo del recetario'] },
  ...
  { day: 26, theme: '🇺🇸 Americana', meals: [
    { time: 'Desayuno', name: 'Wrap', desc: 'Huevo + jamón + aguacate', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/WRAP.png', portions: ['2 tortillas integral', '1 huevo + ½ taza claras', '2 reb jamón de pechuga de pavo', '⅓ aguacate', 'Espinaca y tomate cherry', '1 mandarina'] },
    { time: 'Comida', name: 'Chicken Caesar Bowl', desc: 'Pollo + lechuga + parmesano', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/CHICKEN%20CAESAR%20BOWL.png', portions: ['150 g pechuga de pollo a la plancha', 'Lechuga + espinaca', '2 cdas parmesano rallado', '2 pz papa picada', 'Aderezo del recetario'] },
  ...
  { day: 28, theme: '🇺🇸 Americana', meals: [
    { time: 'Desayuno', name: 'Apple Crumble Avena Horneada', desc: 'Avena + manzana al horno', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/APPLE%20CRUMBLE%20AVENA%20HORNEADA.png', portions: ['1 tz avena', 'Canela, vainilla y pizca de sal', '1 cdita mantequilla', '1 manzana en cubos + canela + 1 cdita miel, hornea todo'] },
    { time: 'Comida', name: 'Tacos Tex Mex', desc: 'Carne molida + queso + pico de gallo', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/TACOS%20TEX%20MEX.png', portions: ['3 tortillas de maíz', '120 g carne molida magra', '30 g queso rallado', 'Pico de gallo y lechuga'] },
...
const planC: DayPlan[] = [
  { day: 1, theme: '🇲🇽 Mexicana', meals: [
    { time: 'Desayuno', name: 'Chilaquiles Ligeros', desc: 'Salsa verde casera · totopos horneados', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/CHILAQUILES%20LIGEROS%20.png', portions: ['Salsa verde hecha en casa', '1 tz totopos horneados', '2 pz de huevo', '30 g queso panela o fresco', '2/3 pz de aguacate'] },
    { time: 'Comida', name: 'Alambre de Pollo', desc: 'Proteína + arroz + verduras', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/ALAMBRE%20DE%20POLLO.png', portions: ['150 g pechuga de pollo salpimentada', 'Pimientos, brócoli, chile y cebolla', '30 g queso oaxaca o mozzarella', '2 pz tortillas o ½ tz arroz cocido'] },
  ...
  { day: 2, theme: '🇲🇽 Mexicana', meals: [
    { time: 'Desayuno', name: 'Omelette', desc: 'Alto en proteína · con pan integral', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/OMELETTE.png', portions: ['2 huevos', '¾ tz claras de huevo', '4 reb pechuga de pavo', 'Espinaca + chile, tomate y cebolla', '2 reb pan integral + 1 tz frutos rojos'] },
    { time: 'Comida', name: 'Caldo de Pollo', desc: 'Reconfortante · con papa', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/CALDO%20DE%20POLLO.png', portions: ['180 g pechuga de pollo cocida', 'Caldo con verduras (chayote, zanahoria, calabaza, ejote)', '1 pz de papa', 'Limón y hierbas al gusto'] },
    { time: 'Cena', name: 'Molletes', desc: 'Frijoles + queso + pico de gallo', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/MOLLETES.png', portions: ['3 reb pan integral', '⅓ tz frijoles cocidos machacados sin grasa', '60 g queso panela o fresco', 'Pico de gallo (chile, tomate, cebolla, limón + sal)'] },
    { time: 'Snack AM', name: 'Snack AM', desc: 'Media mañana', portions: ['½ tz yogur natural sin azúcar + 1 pz manzana picada + ½ pz plátano'] },
    { time: 'Snack PM', name: 'Snack PM', desc: 'Media tarde', portions: ['10 g semillas (cacahuates naturales)'] },
  ]},
  { day: 3, theme: '🇲🇽 Mexicana', meals: [
    { time: 'Desayuno', name: 'Machaca con Nopales', desc: 'Tradicional · con tortillas', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/MACHACA%20CON%20NOPALES.png', portions: ['40 g machaca de res', '½ taza claras de huevo', 'Nopales, tomate + cebolla + chile + cilantro', '2 tortillas de maíz o nopal', '½ aguacate', '1 naranja'] },
  ...
  { day: 4, theme: '🇲🇽 Mexicana', meals: [
    { time: 'Desayuno', name: 'Huevos Rancheros', desc: 'Clásico mexicano · con frijoles', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/HUEVOS%20RANCHEROS.png', portions: ['4 huevos', '⅔ taza frijoles cocidos', 'Nopal picado', '1 tortilla de maíz', '½ pz aguacate', 'Salsa libre (tomate, cebolla, chile, cilantro)'] },
    { time: 'Comida', name: 'Tinga de Pollo', desc: 'Deshebrada · con arroz o tortillas', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/TINGA%20DE%20POLLO.png', portions: ['200 g pechuga de pollo deshebrada', '¾ tz arroz blanco cocido o 3 tortillas', 'Lechuga + tomate + cebolla', '2 cdas salsa chipotle', 'Limón'] },
  ...
  { day: 5, theme: '🇲🇽 Mexicana', meals: [
    ...
    { time: 'Comida', name: 'Asado de Res', desc: 'Con papa y verduras', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/ASADO%20DE%20RES.png', portions: ['180 g carne de res', '2 pz papa, 2 pz tomate, ½ cebolla, 1 ajo', 'Lechuga, zanahoria, pepino, cebolla curtida', '30 g queso panela + ⅓ aguacate'] },
  ...
  { day: 7, theme: '🇲🇽 Mexicana', meals: [
    { time: 'Desayuno', name: 'Calabacitas', desc: 'Con huevo y pan integral', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/CALABACITAS.png', portions: ['Calabacita en cubos, tomate, cebolla y chile', '1 huevo + ½ taza claras', '2 reb pan integral', 'Sal, pimienta y orégano al gusto'] },
    { time: 'Comida', name: 'Bistec de Res', desc: 'Con salsa de tomate y arroz', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/BISTEC%20DE%20RES.png', portions: ['180 g bistec de res salpimentado', 'Salsa de tomate hecha en casa', '¾ tz arroz cocido'] },
    { time: 'Cena', name: 'Ensalada Cremosa de Atún', desc: 'Con papa y pan', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/ENSALADA%20CREMOSA%20DE%20ATUN.png', portions: ['1 lata atún en agua', '2 papa cocida', 'Lechuga picada, pepino y zanahoria rallada', '1 cdita mayonesa light + 1 cda yogurt natural + limón, sal y pimienta', '2 reb pan integral'] },
    { time: 'Snack AM', name: 'Snack AM', desc: 'Media mañana', portions: ['1 pz de pera'] },
    { time: 'Snack PM', name: 'Snack PM', desc: 'Media tarde', portions: ['15 g semillas (cacahuates naturales)'] },
  ]},
  ...
  { day: 9, theme: '🇯🇵 Japonesa', meals: [
    { time: 'Desayuno', name: 'Bowl', desc: 'Huevos + queso de cabra + blueberries', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/BOWL.png', portions: ['3 huevos cocidos', '30 g queso fresco de cabra', 'Espinaca fresca', '⅓ pz de aguacate', '⅓ tz de blueberries'] },
    { time: 'Comida', name: 'Poké Bowl', desc: 'Arroz + proteína + aguacate', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/POKE%20BOWL.png', portions: ['1 ½ tz arroz cocido', '180 g pechuga de pollo', 'Pepino + zanahoria', '30 g queso crema', '⅓ aguacate', 'Salsa soya baja en sodio + naranja + limón'] },
  ...
  { day: 10, theme: '🇯🇵 Japonesa', meals: [
    { time: 'Desayuno', name: 'Avena con Manzana', desc: 'Con leche y semillas', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/AVENA%20CON%20MANZANA.png', portions: ['1 tz avena + agua', '1 tz leche', '1 cda miel + canela en polvo', '½ manzana', '1 cda semillas mixtas'] },
    { time: 'Comida', name: 'Ramen Ligero', desc: 'Fideos + pollo + huevo', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/RAMEN%20LIGERO.png', portions: ['2 tz fideos cocidos', '200 g pollo o tofu firme', 'Espinaca, brócoli y champiñones', '1 huevo cocido', 'Caldo ligero (sal, salsa soya, chile cayena)'] },
  ...
  { day: 11, theme: '🇯🇵 Japonesa', meals: [
    { time: 'Desayuno', name: 'Pancakes de Camote', desc: 'Con yogur y miel', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/PANCAKES%20DE%20CAMOTE.png', portions: ['1 tz puré de camote', '1 huevo + ¼ tz claras', '½ tz avena molida', 'Canela y vainilla', '¼ tz yogur natural + 1 cdta miel (topping)'] },
    { time: 'Comida', name: 'Salmón al Limón', desc: 'Con papa y espárragos', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/SALMON%20AL%20LIMON.png', portions: ['180 g salmón al sartén', '1 cdita mantequilla + ajo + limón', '1 pz de papa', 'Espárragos salteados'] },
  ...
  { day: 14, theme: '🇯🇵 Japonesa', meals: [
    { time: 'Desayuno', name: 'Toast de Huevo', desc: 'Con aguacate y yogur', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/TOAST%20DE%20HUEVO%20.png', portions: ['1 reb pan integral', '¼ pz aguacate', 'Espinaca y champiñones', '1 huevo + ½ taza claras', '¾ taza yogurt natural sin azúcar', '½ taza frutos rojos + 1 cdita miel'] },
    { time: 'Comida', name: 'Bowl de Camarón', desc: 'Con brócoli y arroz', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/BOWL%20DE%20CAMARON%20.png', portions: ['180 g camarones con mantequilla, ajo, paprika + limón y sal', 'Brócoli salteado', 'Salsa soya + limón'] },
    { time: 'Cena', name: 'Gohan de Salmón y Espinaca', desc: 'Arroz + salmón + aguacate', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/GOHAN%20DE%20SALMON%20Y%20ESPINACA.png', portions: ['180 g salmón a la plancha con salsa teriyaki', '1 tz arroz cocido', '⅓ pz aguacate', 'Pepino + zanahoria', 'Salsa soya + limón + naranja', '1 cdita ajonjolí'] },
    { time: 'Snack AM', name: 'Snack AM', desc: 'Media mañana', portions: ['1 taza de uvas'] },
    { time: 'Snack PM', name: 'Snack PM', desc: 'Media tarde', portions: ['2 reb pan integral + 1 cdita crema de cacahuate'] },
  ]},
  { day: 15, theme: '🇮🇹 Italiana', meals: [
    { time: 'Desayuno', name: 'Ricotta Toast Durazno', desc: 'Pan integral + ricotta + fruta', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/RICOTTA%20TOAST%20DURAZNO%20.png', portions: ['3 reb pan integral', '½ tz ricotta light', '1 pz durazno', '1 cdita miel', '1 cdita semillas (chía o girasol)'] },
    { time: 'Comida', name: 'Ensalada Griega', desc: 'Pollo + garbanzos + parmesano', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/ENSALADA%20GRIEGA%20.png', portions: ['200 g pechuga de pollo a la plancha', '1 tz garbanzos cocidos', 'Espinaca + lechuga + tomate cherry + pepino + cebolla morada', '2 cdita queso parmesano', '1 cdita aceite de oliva, limón, orégano'] },
  ...
  { day: 16, theme: '🇮🇹 Italiana', meals: [
    ...
    { time: 'Comida', name: 'Filete de Pescado', desc: 'Con mantequilla y arroz', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/FILETE%20DE%20PESCADO%20.png', portions: ['160 g filete de pescado blanco', '1 cdita mantequilla + ajo + limón', '2 tz arroz cocido', 'Espárragos y zanahoria salteados'] },
    { time: 'Cena', name: 'Puré de Camote', desc: 'Con pollo y brócoli', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/PURE%20DE%20CAMOTE.png', portions: ['1 tz camote cocido y triturado', '180 g pechuga de pollo', '1 tz brócoli cocido', 'Especias: romero, sal, ajo en polvo'] },
  ...
  { day: 20, theme: '🇮🇹 Italiana', meals: [
    ...
    { time: 'Comida', name: 'Pasta con Verduras', desc: 'Con pollo y parmesano', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/PASTA%20CON%20VERDURAS.png', portions: ['1 tz pasta cocida en salsa de tomate', '200 g pechuga de pollo', 'Tomate cherry y brócoli', 'Ajo, albahaca y orégano', '1 cdita parmesano rallado'] },
  ...
  { day: 26, theme: '🇺🇸 Americana', meals: [
    { time: 'Desayuno', name: 'Wrap', desc: 'Huevo + jamón + aguacate', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/WRAP.png', portions: ['1 tortilla integral', '1 huevo + ½ taza claras', '2 reb jamón de pechuga de pavo', '⅓ aguacate', 'Espinaca y tomate cherry', '1 mandarina'] },
    { time: 'Comida', name: 'Chicken Caesar Bowl', desc: 'Pollo + lechuga + parmesano', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/CHICKEN%20CAESAR%20BOWL.png', portions: ['150 g pechuga de pollo a la plancha', 'Lechuga + espinaca', '2 cdas parmesano rallado', '2 pz papa picada', 'Aderezo del recetario'] },
...
const planD: DayPlan[] = [
  { day: 1, theme: '🇲🇽 Mexicana', meals: [
    { time: 'Desayuno', name: 'Chilaquiles Ligeros', desc: 'Salsa verde casera · totopos horneados', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/CHILAQUILES%20LIGEROS%20.png', portions: ['Salsa verde hecha en casa', '½ tz de totopos horneados', '2 pz de huevo', '30 g de queso panela o fresco', '1/3 pz de aguacate'] },
    { time: 'Comida', name: 'Alambre de Pollo', desc: 'Proteína + arroz + verduras', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/ALAMBRE%20DE%20POLLO.png', portions: ['150 g de pechuga de pollo salpimentada', 'Pimientos de colores, brócoli, chile y cebolla', '30 g de queso Oaxaca o mozzarella', '2 pz de tortillas o ½ tz de arroz cocido'] },
  ...
  { day: 2, theme: '🇲🇽 Mexicana', meals: [
    { time: 'Desayuno', name: 'Omelette', desc: 'Alto en proteína · con pan integral', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/OMELETTE.png', portions: ['2 huevos', '½ tz de claras de huevo', '2 reb de pechuga de pavo (jamón bajo en grasa)', 'Espinaca + chile, tomate y cebolla', '1 reb pan integral', '1 tz de frutos rojos'] },
    { time: 'Comida', name: 'Caldo de Pollo', desc: 'Reconfortante · con papa', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/CALDO%20DE%20POLLO.png', portions: ['150 g pechuga de pollo cocida', 'Caldo con verduras (chayote, zanahoria, calabaza, ejote)', '1 pz de papa', 'Limón y hierbas al gusto'] },
  ...
  { day: 4, theme: '🇲🇽 Mexicana', meals: [
    { time: 'Desayuno', name: 'Huevos Rancheros', desc: 'Clásico mexicano · con frijoles', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/HUEVOS%20RANCHEROS.png', portions: ['2 huevos', '⅔ taza frijoles cocidos', 'Nopal picado', '1 tortilla de maíz', '½ pz aguacate', 'Salsa libre (tomate, cebolla, chile, cilantro)'] },
    { time: 'Comida', name: 'Tinga de Pollo', desc: 'Deshebrada · con arroz o tortillas', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/TINGA%20DE%20POLLO.png', portions: ['200 g pechuga de pollo deshebrada', '½ tz arroz blanco cocido o 2 pz de tortillas', 'Lechuga + tomate + cebolla', '2 cdas salsa chipotle', 'Limón'] },
    { time: 'Cena', name: 'Quesadillas con Champiñones', desc: 'Ligeras · con caldo', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/QUESADILLAS%20CON%20CHAMPINONES.png', portions: ['2 tortillas de maíz', '60 g queso panela o fresco', 'Champiñones con cebolla', 'Salsa verde', '1 taza caldo de verduras'] },
  ...
  { day: 7, theme: '🇲🇽 Mexicana', meals: [
    { time: 'Desayuno', name: 'Calabacitas', desc: 'Con huevo y pan integral', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/CALABACITAS.png', portions: ['Calabacita en cubos, tomate, cebolla y chile', '1 huevo + ½ taza claras', '2 reb pan integral', 'Sal, pimienta y orégano al gusto'] },
    { time: 'Comida', name: 'Bistec de Res', desc: 'Con salsa de tomate y arroz', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/BISTEC%20DE%20RES.png', portions: ['150 g bistec de res', 'Salpimentar al gusto', 'Salsa de tomate hecha en casa (tomate, cebolla y chile)', '¾ taza arroz cocido'] },
  ...
  { day: 8, theme: '🇯🇵 Japonesa', meals: [
    ...
    { time: 'Comida', name: 'Pollo Teriyaki', desc: 'Con arroz y verduras', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/POLLO%20TERIYAKI.png', portions: ['180 g pechuga de pollo', '1 tz arroz cocido', 'Brócoli, zanahoria en tiras, calabacita o pimiento', 'Salsa teriyaki ligera casera'] },
  ...
  { day: 9, theme: '🇯🇵 Japonesa', meals: [
    { time: 'Desayuno', name: 'Bowl', desc: 'Huevos + queso de cabra + blueberries', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/BOWL.png', portions: ['3 huevos cocidos', '30 g de queso fresco de cabra', 'Espinaca fresca', '⅓ pz de aguacate', '⅓ tz de blueberries'] },
    { time: 'Comida', name: 'Poké Bowl', desc: 'Arroz + proteína + aguacate', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/POKE%20BOWL.png', portions: ['1 taza arroz cocido', '150 g pechuga de pollo', 'Pepino + zanahoria', '30 g de queso crema', '⅓ aguacate', 'Salsa soya baja en sodio + naranja + limón'] },
  ...
  { day: 11, theme: '🇯🇵 Japonesa', meals: [
    ...
    { time: 'Comida', name: 'Salmón al Limón', desc: 'Con papa y espárragos', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/SALMON%20AL%20LIMON.png', portions: ['120 g salmón al sartén con 1 cdita mantequilla + ajo + jugo de limón', '1 pz de papa', 'Espárragos salteados'] },
  ...
  { day: 14, theme: '🇯🇵 Japonesa', meals: [
    ...
    { time: 'Comida', name: 'Bowl de Camarón', desc: 'Con brócoli y salsa soya', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/BOWL%20DE%20CAMARON%20.png', portions: ['180 g camarones con 1 cdita mantequilla + ajo + paprika + limón y sal', 'Brócoli salteado', 'Salsa soya baja en sodio + limón'] },
  ...
  { day: 15, theme: '🇮🇹 Italiana', meals: [
    { time: 'Desayuno', name: 'Ricotta Toast Durazno', desc: 'Pan integral + ricotta + fruta', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/RICOTTA%20TOAST%20DURAZNO%20.png', portions: ['2 reb pan integral', '¼ tz ricotta light', '1 pz durazno', '1 cdita miel', '1 cdita semillas', 'Canela o menta fresca (opcional)'] },
    { time: 'Comida', name: 'Ensalada Griega', desc: 'Pollo + garbanzos + parmesano', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/ENSALADA%20GRIEGA%20.png', portions: ['200 g pechuga de pollo a la plancha', '½ tz garbanzos cocidos', 'Espinaca + lechuga', 'Tomate cherry, pepino, cebolla morada', '2 cdita queso parmesano', '1 cdita aceite de oliva, jugo de limón, orégano, pimienta'] },
  ...
  { day: 17, theme: '🇮🇹 Italiana', meals: [
    { time: 'Desayuno', name: 'Toast', desc: 'Aguacate + huevo + tomate', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/TOAST.png', portions: ['2 reb de pan integral', '⅓ pz aguacate', 'Rodajas de tomate', '3 pz de huevo estrellado', 'Sal, jugo de limón, pimienta al gusto', '1 pz de kiwi'] },
  ...
  { day: 19, theme: '🇮🇹 Italiana', meals: [
    { time: 'Desayuno', name: 'Smoothie de Frutos Rojos', desc: 'Yogur + avena + chía', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/SMOOTHIE%20DE%20FRUTOS%20ROJOS.png', portions: ['½ taza yogurt natural sin azúcar', '½ tz leche (descremada o vegetal sin azúcar)', '½ taza frutos rojos (fresas, moras, arándanos)', '2 cdas avena natural', '1 cdita miel', '1 cdita semillas de chía', 'Hielos + agua si es necesario'] },
  ...
  { day: 21, theme: '🇮🇹 Italiana', meals: [
    { time: 'Desayuno', name: 'Ricotta Toast', desc: 'Con fresas y semillas', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/RICOTTA%20TOAST.png', portions: ['2 reb pan integral', '3 cda ricotta light', '1 tz fresas picadas', '1 cdita miel', '1 cdita semillas (chía o girasol)'] },
    { time: 'Comida', name: 'Pollo al Romero', desc: 'Con papa y verduras', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/POLLO%20AL%20ROMERO.png', portions: ['150 g pechuga de pollo a la plancha o al horno', '1 papa cocida', 'Espinaca, tomate cherry y pepino', 'Romero, ajo, limón y pimienta'] },
  ...
  { day: 22, theme: '🇺🇸 Americana', meals: [
    ...
    { time: 'Comida', name: 'Hamburguesa Ligera', desc: 'Carne magra + pan integral', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/HAMBURGUESA%20LIGERA.png', portions: ['150 g carne molida magra', '2 reb pan integral', '⅓ pz aguacate', '30 g queso fresco o mozzarella', 'Lechuga, tomate, cebolla, pepino en rodajas', '1 taza camote al horno o papa'] },
  ...
  { day: 26, theme: '🇺🇸 Americana', meals: [
    { time: 'Desayuno', name: 'Wrap', desc: 'Huevo + jamón + aguacate', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/WRAP.png', portions: ['1 tortilla integral', '1 huevo + ½ taza claras de huevo', '2 reb jamón de pechuga de pavo', '⅓ aguacate', 'Espinaca y tomate cherry', '1 mandarina (acompañamiento)'] },
    { time: 'Comida', name: 'Chicken Caesar Bowl', desc: 'Pollo + lechuga + parmesano', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/CHICKEN%20CAESAR%20BOWL.png', portions: ['120 g pechuga de pollo a la plancha', 'Lechuga + espinaca', '2 cdas parmesano rallado', '1 pz de papa picada', 'Aderezo (elige tu favorito del recetario de salsas y aderezos)'] },
  ...
  { day: 28, theme: '🇺🇸 Americana', meals: [
    { time: 'Desayuno', name: 'Apple Crumble Avena Horneada', desc: 'Avena + manzana al horno', img: 'https://ltveorvqvvlyivjwxjlc.supabase.co/storage/v1/object/public/healthyspaceclub/APPLE%20CRUMBLE%20AVENA%20HORNEADA.png', portions: ['Mezcla ½ taza avena', 'Canela, vainilla y pizca de sal', '1 cdita mantequilla', '1 manzana en cubos + canela + 1 cdita miel, luego hornea todo'] },
...
// i18n de contenido (A3a): nombres de comida traducidos cuando locale==='en'
// (overlay mealPlan.en.ts). desc + portions → A3b/A3c (siguen en español).
...
export function getMealPlans(lang: AppLanguage): Record<string, DayPlan[]> {
  if (lang !== 'en') return mealPlans;
  if (_mealPlansEnCache) return _mealPlansEnCache;
  const out: Record<string, DayPlan[]> = {};
  for (const key of Object.keys(mealPlans)) {
    out[key] = mealPlans[key].map((day) => ({
      ...day,
      meals: day.meals.map((m) => {
        const en = mealNamesEn[m.name];
        return en ? { ...m, name: en } : m;
      }),
    }));
  }
  _mealPlansEnCache = out;
  return out;
}
