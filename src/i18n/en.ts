...
export const en: Translations<typeof es> = {
  ...
  managePlan: {
    ...
    faq4a: 'Yes. The yearly plan costs roughly the equivalent of 9 months — you save ~3 months per year vs paying monthly.',
  ...
  profile: {
    ...
    workoutHistoryLabel: 'Your training',
    workoutHistoryThisWeek: 'This week',
    workoutHistorySessionsOne: '{n} session',
    workoutHistorySessionsOther: '{n} sessions',
    workoutHistoryHours: '{h}h',
    workoutHistoryEmpty: "You haven't trained yet",
    workoutHistoryRecent: 'Recent',
    workoutHistorySeriesOne: '{n} set',
    workoutHistorySeriesOther: '{n} sets',
    modalityFuerza: 'Strength',
    modalityCardio: 'Cardio',
    modalityYoga: 'Yoga',
    modalityAuto: 'Training',
  },
  club: {
    title: 'The Club',
