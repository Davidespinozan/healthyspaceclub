...
export const en: Translations<typeof es> = {
  ...
  espacio: {
    ...
    introTitle: "You don't answer questions. You shape yourself.",
    introBody: 'Each reflection shapes the portrait of who you are becoming, across 10 dimensions of your life. The more you show up, the more the app knows you — and the more it gives back.',
    introCta: 'Begin',
