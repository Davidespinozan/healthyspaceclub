...
export const en: Translations<typeof es> = {
  ...
  checkout: {
    secureNote: "We'll take you to Stripe's secure checkout to finish.",
    opening: 'Opening secure checkout…',
    error: "Couldn't start checkout. Please try again.",
    activating: 'Activating your plan…',
    activatingSub: 'This may take a few seconds.',
    successTitle: "You're all set! Your plan is active",
    successSub: 'Your 3-day trial has started. Welcome to the Club.',
    goToApp: 'Go to the app',
    slowTitle: 'This may take a moment',
    slowSub: "We're confirming your payment. If you already paid, retry in a few seconds.",
    retry: 'Retry',
    cancelTitle: 'Payment not completed',
    cancelSub: 'You were not charged. You can try again anytime.',
    back: 'Back',
  },
  settings: {
    language: 'Language',
