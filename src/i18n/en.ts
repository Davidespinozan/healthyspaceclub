...
export const en: Translations<typeof es> = {
  ...
  landing: {
    ...
    f1Sub: 'Analyzes your data, habits and goals to build the perfect plan for you.',
    f2Title: 'Train anywhere',
    f2Sub: 'Personalized routines with video and real-time tracking.',
    f3Title: 'Nutrition made simple',
    f3Sub: 'Flexible meal plans, shopping lists and healthy recipes.',
    f4Title: 'A community that drives you',
    f4Sub: "You're not alone. Share, motivate and reach your best self with others.",
    bannerKicker: 'Your trainer in your pocket',
    bannerTitle: 'Take your plan everywhere',
    bannerTitlePre: 'Take your plan',
    ...
    ctaFinalTitle: 'Ready for your best self?',
    ctaFinalSub: 'Start today. Your future self will thank you.',
