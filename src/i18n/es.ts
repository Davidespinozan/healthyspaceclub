...
export const es = {
  ...
  checkout: {
    secureNote: 'Te llevamos al checkout seguro de Stripe para terminar.',
    opening: 'Abriendo el checkout seguro…',
    error: 'No se pudo iniciar el checkout. Intentá de nuevo.',
    activating: 'Activando tu plan…',
    activatingSub: 'Esto puede tardar unos segundos.',
    successTitle: '¡Listo! Tu plan está activo',
    successSub: 'Arrancó tu prueba de 3 días. Bienvenido al Club.',
    goToApp: 'Ir a la app',
    slowTitle: 'Puede tardar un momento',
    slowSub: 'Estamos confirmando tu pago. Si ya pagaste, reintentá en unos segundos.',
    retry: 'Reintentar',
    cancelTitle: 'No se completó el pago',
    cancelSub: 'No se te cobró nada. Podés intentarlo cuando quieras.',
    back: 'Volver',
  },
  settings: {
    language: 'Idioma',
