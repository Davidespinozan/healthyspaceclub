...
export const es = {
  ...
  partners: {
    eyebrow: 'Entrenar juntos',
    title: 'Tus compañeros',
    heroTitle: 'Tu entrenamiento. Alguien contigo.',
    whoTitle: '¿Con quién quieres entrenar?',
    notHereTitle: '¿Todavía no está en Healthy Space?',
    inviteToJoin: 'Invítalo a unirse',
    heroLine: 'Alguien que aparece contigo — y así apareces tú los días que solo no lo harías.',
    promise: 'Entrena con alguien — no lo hagas solo. Hay dos formas:',
    modesIntro: 'Dos formas de entrenar juntos',
    mode1Title: 'Juntos, en vivo',
    mode1Body: 'La misma sesión. Se ven avanzar en tiempo real.',
    mode2Title: 'A distancia',
    mode2Body: 'Cada quien entrena lo suyo, y los dos ven que aparecieron.',
    searchToggle: '¿Ya está en Healthy Space? Búscalo.',
    searchLabel: 'Buscar personas en Healthy Space',
    searching: 'Buscando…',
    connect: 'Conectar',
    addPartner: 'Añadir compañero',
    loading: 'Cargando…',
    actionError: 'No se pudo completar. Reintenta.',
    inviteBlocked: 'No puedes conectar con esta persona.',
    todayLabel: 'HOY',
    trainedYes: 'Ya apareció',
    trainedNo: 'Aún no entrena hoy',
    duoDaysLabel: 'días juntos',
    duoDaysAria: '{n} días juntos en racha',
  ...
  espacio: {
    ...
    introTitle: 'No respondes preguntas. Te conoces mejor.',
    introBody: 'Una pregunta al día da forma al retrato de quién te estás volviendo. Entre más apareces, más se afina — y más te devuelve.',
    introCta: 'Empezar',
    // REFLECTION-UX-1 · llegada (arrival) + bifurcador + progreso honesto
    eyebrow: 'TU ESPACIO',
    todayCue: 'Hoy',
    meta: '~3 min · sin respuestas correctas',
    arrivalTitle: 'Tu espacio de hoy',
    arrivalLine: 'Una pregunta para volver a ti.',
    progressToday: 'Tu reflexión de hoy',
    progressMore: 'Una más, si quieres',
    forkTitle: 'Ya cumpliste por hoy.',
    forkSub: 'Tu reflexión esencial quedó guardada. ¿La ves, o sigues un poco más?',
    forkSeeReview: 'Ver mi reflexión',
    forkContinue: 'Seguir profundizando',
    textareaLabel: 'Tu reflexión',
