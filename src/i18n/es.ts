...
export const es = {
  ...
  profile: {
    ...
    workoutHistoryLabel: 'Tu entrenamiento',
    workoutHistoryThisWeek: 'Esta semana',
    workoutHistorySessionsOne: '{n} sesión',
    workoutHistorySessionsOther: '{n} sesiones',
    workoutHistoryHours: '{h}h',
    workoutHistoryEmpty: 'Aún no has entrenado',
    workoutHistoryRecent: 'Recientes',
    workoutHistorySeriesOne: '{n} serie',
    workoutHistorySeriesOther: '{n} series',
    modalityFuerza: 'Fuerza',
    modalityCardio: 'Cardio',
    modalityYoga: 'Yoga',
    modalityAuto: 'Entrenamiento',
  },
  club: {
    title: 'El Club',
