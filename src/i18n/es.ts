...
export const es = {
  ...
  landing: {
    ...
    f1Title: 'IA que te entiende',
    f1Sub: 'Analiza tus datos, hábitos y objetivos para crear el plan perfecto para ti.',
    f2Title: 'Entrena donde quieras',
    f2Sub: 'Rutinas personalizadas con video y seguimiento en tiempo real.',
    f3Title: 'Nutrición sin complicaciones',
    f3Sub: 'Planes de comidas flexibles, listas de compra y recetas saludables.',
    f4Title: 'Comunidad que impulsa',
    f4Sub: 'No estás solo. Comparte, motiva y alcanza tu mejor versión junto a otros.',
    bannerKicker: 'Tu entrenador en el bolsillo',
    bannerTitle: 'Lleva tu plan siempre contigo',
    bannerTitlePre: 'Lleva tu plan',
    ...
    ctaFinalTitle: '¿Listo para tu mejor versión?',
    ctaFinalSub: 'Empieza hoy. Tu futuro te lo agradecerá.',
